...
plt.savefig(f'{PATH}/pics/sample_a.png', bbox_inches='tight')
# plt.show()
plt.close()
...
plt.ylabel('$y$')
plt.legend(shadow=True)
plt.savefig(f'{PATH}/pics/sample_u.png', bbox_inches='tight')
# plt.show()
plt.close()
...
plt.ylabel('$y$')
plt.legend(shadow=True)
plt.savefig(f'{PATH}/pics/sample_f.png', bbox_inches='tight')
# plt.show()
plt.close()
