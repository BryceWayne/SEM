...
parser.add_argument("--ks", type=int, default=3, choices=[3, 5, 7, 9, 11, 13, 15, 17])
...
for epoch in tqdm(range(1, EPOCHS+1)):
	...
	if np.isnan(loss_train):
		try:
			...
			model.train()
			optimizer = torch.optim.LBFGS(model.parameters(), history_size=50, tolerance_grad=1e-15, tolerance_change=1e-15, max_eval=50)
